...
function renderCards() {
  ...
  container.innerHTML = visibleCourses.map(pro => `
     <div class="w-full bg-white rounded-[12px] shadow-md p-4 flex flex-col space-y-4 dark:bg-gray-700 dark:text-white transition-all  duration-300 hover:scale-105" onClick="location.href='./courseDetail.html?id=${pro.id}'">
